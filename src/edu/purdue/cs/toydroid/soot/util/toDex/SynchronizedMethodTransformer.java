...
public class SynchronizedMethodTransformer extends BodyTransformer {
	private static SynchronizedMethodTransformer instance_soot_toDex_SynchronizedMethodTransformer;

	public SynchronizedMethodTransformer(Singletons.Global g) {
	}

	public SynchronizedMethodTransformer() {
	}

	public static SynchronizedMethodTransformer v() {
		if (instance_soot_toDex_SynchronizedMethodTransformer == null) {

			instance_soot_toDex_SynchronizedMethodTransformer = new SynchronizedMethodTransformer();
